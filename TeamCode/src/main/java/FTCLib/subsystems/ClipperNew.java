...
@Config
public class ClipperNew extends SubsystemBase {
    private final Bot bot;

    private final DcMotor outtakeSlide;
    private final PIDController controller;
    public static double kP = 0.005, kI = 0.0, kD = 0.0;
    public static double target = 0.0, threshold = 3, minExtension = 0.0, maxExtension = 200;

    public ClipperNew(Bot bot) {
        this.bot = bot;
        outtakeSlide = bot.hardwareMap.get(DcMotor.class, "Clipper");
