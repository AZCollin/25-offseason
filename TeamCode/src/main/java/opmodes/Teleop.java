...
public class Teleop extends PedroOpMode {
    ...
    private void registerControls() {
        ...
        gamepadManager.getGamepad1().getDpadDown().setPressedCommand(Belt.INSTANCE::downPosition);
        gamepadManager.getGamepad1().getDpadUp().setPressedCommand(Belt.INSTANCE::upPosition);
